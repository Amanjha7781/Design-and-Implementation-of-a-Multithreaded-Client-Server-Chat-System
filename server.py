...
# I've used the standard localhost IP (127.0.0.1) to ensure it works on your machine.
host = '127.0.0.1' 
    ...
    while True:
        try:
            ...
            if client in clients:
                ...
                clients.remove(client) # Corrected: ensures the client is removed from the 'clients' list
                client.close()
...
def receive():
    while True:
        ...
        # Check if bans.txt exists, create it if not, then read bans
        try:
